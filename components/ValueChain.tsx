        ...
        {stageOrder.map((stage, i) => {
          ...
          return (
            <div key={stage} className="relative flex-1 md:min-w-0">
              <div className="flex h-full flex-col border border-ink/15 bg-parchment p-5 md:p-6">
              ...
              {!isLast && (
                <div
                  aria-hidden="true"
                  className="absolute -bottom-3 left-1/2 z-10 flex h-6 w-6 -translate-x-1/2 rotate-90 items-center justify-center text-leaf md:-right-3 md:bottom-auto md:left-auto md:top-1/2 md:-translate-y-1/2 md:translate-x-0 md:rotate-0"
                >
